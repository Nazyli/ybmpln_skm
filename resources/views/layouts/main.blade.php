          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ url('#') }}">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ url('img/man.png') }}" style="max-width: 60px" alt="">
                    <div class="status-indicator bg-success"></div>
                  </div>
                  <div class="font-weight-bold">
                    <div class="text-truncate">Hi there! I am wondering  you can help me with a problem Ive been
                      having.</div>
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ url('#') }}">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ url('img/girl.png') }}" style="max-width: 60px" alt="">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item align-items-center" href="{{ url('#') }}">
                  <div class="mb-3">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="{{ url('#') }}">View All Taks</a>
              </div>
            </li>
