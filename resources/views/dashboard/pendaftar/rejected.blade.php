...
@section('breadcrumb', 'Home,List Rejected;rejected')
        ...
        <div class="col-lg-12">
            <div class="card card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">List Data Tidak Direkomendasikan - <span class="badge badge-danger">Rejected</span></h6>
                    <div class="btn-group">
